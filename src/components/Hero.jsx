      ...
      <div className="container relative" ref={parallaxRef}>
        ...
        >
          <h1 className="h1 mb-6">
            Libere sua criatividade de&nbsp;forma&nbsp;visual com o{` `}
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            Libere o poder da IA com Artesão. Atualize sua produtividade
            e crie artes incríveis, com o aplicativo de arte com IA.
          </p>
